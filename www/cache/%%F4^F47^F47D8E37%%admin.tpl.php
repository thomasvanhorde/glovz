<?php /* Smarty version 2.6.26, created on 2011-03-16 20:34:31
         compiled from /Users/aenyhm/Sites/www/glovz/trunk/engine/view/admin.tpl */ ?>
...
-->
		...
		<!-- Reset Stylesheet -->
		<link rel="stylesheet" href="http://<?php echo $this->_tpl_vars['HTTP_HOST']; ?>
/<?php echo $this->_tpl_vars['SYS_FOLDER']; ?>
/themes/admin/reset.css" type="text/css" media="screen">

		<!-- Main Stylesheet -->
		<link rel="stylesheet" href="http://<?php echo $this->_tpl_vars['HTTP_HOST']; ?>
/<?php echo $this->_tpl_vars['SYS_FOLDER']; ?>
/themes/admin/style.css" type="text/css" media="screen">

        <!-- Invalid Stylesheet. This makes stuff look pretty. Remove it if you want the CSS completely valid -->
        <link rel="stylesheet" href="http://<?php echo $this->_tpl_vars['HTTP_HOST']; ?>
/<?php echo $this->_tpl_vars['SYS_FOLDER']; ?>
/themes/admin/invalid.css" type="text/css" media="screen">

        <!-- Invalid Stylesheet. This makes stuff look pretty. Remove it if you want the CSS completely valid -->
        <link rel="stylesheet" href="http://<?php echo $this->_tpl_vars['HTTP_HOST']; ?>
/<?php echo $this->_tpl_vars['SYS_FOLDER']; ?>
/themes/admin/datepicker/datepicker.css" type="text/css" media="screen">
		...
		<!-- jQuery -->
		<script type="text/javascript" src="http://<?php echo $this->_tpl_vars['HTTP_HOST']; ?>
/<?php echo $this->_tpl_vars['SYS_FOLDER']; ?>
/js/admin/jquery-1.js"></script>

		<!-- jQuery Configuration -->
		<script type="text/javascript" src="http://<?php echo $this->_tpl_vars['HTTP_HOST']; ?>
/<?php echo $this->_tpl_vars['SYS_FOLDER']; ?>
/js/admin/simpla.js"></script>

		<!-- Facebox jQuery Plugin -->
		<script type="text/javascript" src="http://<?php echo $this->_tpl_vars['HTTP_HOST']; ?>
/<?php echo $this->_tpl_vars['SYS_FOLDER']; ?>
/js/admin/facebox.js"></script>
...
/js/admin/jquery.js"></script>
    ...
    <script type="text/javascript" src="http://<?php echo $this->_tpl_vars['HTTP_HOST']; ?>
/<?php echo $this->_tpl_vars['SYS_FOLDER']; ?>
/js/admin/datepicker/datepicker.packed.js"></script>
		...
		<div id="sidebar"><div id="sidebar-wrapper"> <!-- Sidebar with logo and menu -->
			...
			<!-- Logo (221px wide) -->
			<a href="#"><img id="logo" src="http://<?php echo $this->_tpl_vars['HTTP_HOST']; ?>
/<?php echo $this->_tpl_vars['SYS_FOLDER']; ?>
/themes/admin/style/logo.png" alt="Simpla Admin logo"></a>
			...
			<?php echo $this->_tpl_vars['mainNav']; ?>
