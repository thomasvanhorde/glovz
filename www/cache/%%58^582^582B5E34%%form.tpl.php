<?php /* Smarty version 2.6.26, created on 2011-03-16 22:31:55
         compiled from controller/project/view/form.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'utf8_decode', 'controller/project/view/form.tpl', 23, false),array('modifier', 'explode', 'controller/project/view/form.tpl', 100, false),)), $this); ?>
...
"><?php echo ((is_array($_tmp=$this->_tpl_vars['contentRefElement2']['prenom'])) ? $this->_run_mod_handler('utf8_decode', true, $_tmp) : utf8_decode($_tmp)); ?>
 <?php echo ((is_array($_tmp=$this->_tpl_vars['contentRefElement2']['nom'])) ? $this->_run_mod_handler('utf8_decode', true, $_tmp) : utf8_decode($_tmp)); ?>
</option>
                            <?php endforeach; endif; unset($_from); ?>
                        <?php endif; ?>
                    <?php endforeach; endif; unset($_from); ?>
