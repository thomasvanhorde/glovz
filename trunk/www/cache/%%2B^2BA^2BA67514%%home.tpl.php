<?php /* Smarty version 2.6.26, created on 2011-03-20 23:12:22
...
unset($_smarty_tpl_vars);
 ?>
        ...
        <!-- EN-TÊTE -->
        <?php $_smarty_tpl_vars = $this->_tpl_vars;
$this->_smarty_include(array('smarty_include_tpl_file' => 'view/menu/userbar.tpl', 'smarty_include_vars' => array()));
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
 ?>
